...
from LoadData import loadTrainingData_Phase1, loadTestData_Phase1, write_labels_test
...
if __name__ == '__main__':
    ...
    #     "B I O O O O B".split()
    # )]
    training_data = loadTrainingData_Phase1(train_reviews_path, train_labels_path)
    ...
    tag_to_ix = {"B-As": 0, "I-As": 1, "B-Op": 2, "I-Op": 3, "O": 4, START_TAG: 5, STOP_TAG: 6}
